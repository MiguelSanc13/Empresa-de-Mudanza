...
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(1,'16/11/2016','17/11/2016','09:00', 4);
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(2,'20/05/2016','15/07/2016','22:00', 10)
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(3,'24/12/2016','30/12/2016','15:00', 1)
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(4,'31/12/2016','01/01/2017','00:00', 5)
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(5,'05/11/2016','10/11/2016','10:00', 3)
insert into MANTENIMIENTO(ID_MANTENIMIENTO, FECHA_INICIO_MANT, FECHA_FIN_MANT, HORA_INICIO_MANT, NUMERO_MANT)
values(6,'20/02/2016','20/02/2016','16:00', 2)
...
values(1,1,1,'10','1','16/11/2016','#1');
insert into OBSERVACION(ID_OBSERVACION, ID_CLIENTE,ID_EMPLEADO, NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO,FECHA_OB,GRUPO)
values(2,2,2,'15','5','20/05/2016','#2');
insert into OBSERVACION(ID_OBSERVACION, ID_CLIENTE,ID_EMPLEADO, NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO,FECHA_OB,GRUPO)
values(3,3,3,'20','2','05/06/2016','#3');
insert into OBSERVACION(ID_OBSERVACION, ID_CLIENTE,ID_EMPLEADO, NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO,FECHA_OB,GRUPO)
values(4,4,4,'30','2','25/12/2016','#4');
insert into OBSERVACION(ID_OBSERVACION, ID_CLIENTE,ID_EMPLEADO, NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO,FECHA_OB,GRUPO)
values(5,5,5,'25','3','15/08/2016','#5');
...
insert into VEHICULO(ID_VEHICULO,ID_MANTENIMIENTO, CD_VEHICULO, TIPO_VEHICULO, PLACA_VEHICULO, COLOR_VEHICULO)
values(4, 4,'4ABC13','Traile','MAS-2021','VERDE')
insert into VEHICULO(ID_VEHICULO,ID_MANTENIMIENTO, CD_VEHICULO, TIPO_VEHICULO, PLACA_VEHICULO, COLOR_VEHICULO)
...
/*EL NUMERO DE MANTENIMEINTO POR VEHICULO QUE SE LE AH DADO AL VEHICULO*/

select NOMBRE_EMPRESA, CD_VEHICULO, PLACA_VEHICULO, NUMERO_MANT, FECHA_INICIO_MANT, FECHA_FIN_MANT, COLOR_VEHICULO, TIPO_VEHICULO from EMPRESA, VEHICULO inner join MANTENIMIENTO 
ON  VEHICULO.ID_VEHICULO=MANTENIMIENTO.ID_MANTENIMIENTO
WHERE VEHICULO.CD_VEHICULO=CD_VEHICULO
GROUP BY CD_VEHICULO, PLACA_VEHICULO, NUMERO_MANT, FECHA_INICIO_MANT, FECHA_FIN_MANT, COLOR_VEHICULO, TIPO_VEHICULO, NOMBRE_EMPRESA
ORDER BY CD_VEHICULO;

/*EL PERSONAL DE APOYO EN CUANTAS TAREAS DE MUDANZA HA ESTADO*/

SELECT NOMBRE_PERSONAL, APELLIDO_PERSONAL, NUMERO_TRASL, FECHA_INGRESO_PERSONAL, FECHA_SALIDA_PERSONAL
FROM TRASLADO inner join PERSONAL_EXTRA
ON TRASLADO.ID_TRASLADO=PERSONAL_EXTRA.ID_PERSONAL
WHERE TRASLADO.NUMERO_TRASL=NUMERO_TRASL
GROUP BY NOMBRE_PERSONAL, APELLIDO_PERSONAL, NUMERO_TRASL, FECHA_INGRESO_PERSONAL, FECHA_SALIDA_PERSONAL
ORDER BY APELLIDO_PERSONAL;

/*PERONAL QUE HA TRABAJADO EN TAREA DE MUDANZA QUE HAN TENIDO PUNTUACION MAS ALTA */

SELECT TOP 3 NOMBRES_EMPLEADO, APELLIDOS_EMPLEADO, GRUPO, NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO FROM  OBSERVACION inner join EMPLEADO
ON OBSERVACION.ID_OBSERVACION=EMPLEADO.ID_EMPLEADO
WHERE OBSERVACION.NUMERO_SASTIFECHO=NUMERO_SASTIFECHO
GROUP BY NOMBRES_EMPLEADO, APELLIDOS_EMPLEADO, GRUPO,  NUMERO_SASTIFECHO, NUMERO_INSASTIFECHO
ORDER BY NUMERO_SASTIFECHO DESC;
